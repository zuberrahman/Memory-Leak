    ...
    <DetailWrapper>
      ...
      <RightContainer>
        ...
        <form action="http://127.0.0.1:5501/index.html" >
         <Donate type="submit" target="_blank">Ownership</Donate>
      </form>
      <form action="http://127.0.0.1:5503/index.html" >
         <Donate type="submit" target="_blank">Transfer of Ownership</Donate>
      </form>
      </RightContainer>
    </DetailWrapper>
  );
